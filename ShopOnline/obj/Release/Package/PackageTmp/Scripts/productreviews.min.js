    ...
    "undefined" == typeof BPR && (BPR = {
        ...
        raty: function(n) {
            ...
            var t = {
                ...
                _adjustHints: function() {
                    ...
                    if (this.opt.hints || (this.opt.hints = []), this.opt.halfShow || this.opt.half)
                        for (f = this.opt.precision ? 10 : 2, t = 0; t < this.opt.number; t++)
                            for (n = this.opt.hints[t], Object.prototype.toString.call(n) !== "[object Array]" && (n = [n]), this.opt.hints[t] = [], i = 0; i < f; i++) u = n[i], r = n[n.length - 1], r === undefined && (r = null), this.opt.hints[t][i] = u === undefined ? r : u
                },
                ...
                _getScoreByPosition: function(i, r) {
                    var u = parseInt(r.alt || r.getAttribute("data-alt"), 10),
                        f, e;
            ...
            n.fn.raty = function(i) {
                ...
                if (typeof i != "object" && i) n.error("Method " + i + " does not exist!");
        ...
        loadTemplate: function(n) {
            ...
            function s(n, t) {
                if (t === "this") return n;
                for (var u = t.split("."), r, i = n;
                    (r = u.shift()) && typeof i != "undefined" && i != null;) i = i[r];
                return i
            }

            function i(t, i, r, f) {
                var o = t.attr("data-format-target"),
                    e, s;
        ...
        pagination: function(n) {
                ...
                _draw: function() {
                    ...
                    if (t.destroy.call(this), s = typeof this.prop == "function" ? this.prop("tagName") : this.attr("tagName"), f = s === "UL" ? this : n("<ul" + (i.listStyle ? ' class="' + i.listStyle + '"' : "") + "><\/ul>").appendTo(this), i.prevText && t._appendItem.call(this, i.invertPageOrder ? i.currentPage + 1 : i.currentPage - 1, {
                        ...
                        if (r.end < i.pages && i.edges > 0) {
                            if (i.useStartEdge)
                                for (o = Math.max(i.pages - i.edges, r.end), u = i.pages - 1; u >= o; u--) t._appendItem.call(this, u);
                        ...
                        if (i.useStartEdge)
                            for (e = Math.min(i.edges, r.start), u = 0; u < e; u++) t._appendItem.call(this, u);
                    ...
                    if (i.invertPageOrder)
                        for (u = r.end - 1; u >= r.start; u--) t._appendItem.call(this, u);
                    else
                        for (u = r.start; u < r.end; u++) t._appendItem.call(this, u);
                    if (i.invertPageOrder) {
                        if (r.start > 0 && i.edges > 0 && (i.edges < r.start && r.start - i.edges != 1 ? f.append('<li class="disabled"><span class="ellipse">' + i.ellipseText + "<\/span><\/li>") : r.start - i.edges == 1 && t._appendItem.call(this, i.edges), i.useEndEdge))
                            for (e = Math.min(i.edges, r.start), u = e - 1; u >= 0; u--) t._appendItem.call(this, u)
                        ...
                        for (o = Math.max(i.pages - i.edges, r.end), u = o; u < i.pages; u++) t._appendItem.call(this, u);
                    i.nextText && !i.nextAtFront && t._appendItem.call(this, i.invertPageOrder ? i.currentPage - 1 : i.currentPage + 1, {
                        text: i.nextText,
                        classes: "next"
                    });
            ...
            n.fn.pagination = function(i) {
                ...
                if (typeof i != "object" && i) n.error("Method " + i + " does not exist on jQuery.pagination");
                else return t.init.apply(this, arguments)
            }
        },
        swiper: function() {
                ...
                var n, t = function(r, u) {
                        ...
                        function st(t, i) {
                            var r = n(t.target),
                                u;
                            if (!r.is(i))
                                if (typeof i == "string") r = r.parents(i);
                        ...
                        function wt(n) {
                            ...
                            if (!n.shiftKey && !n.altKey && !n.ctrlKey && !n.metaKey && (!document.activeElement || !document.activeElement.nodeName || document.activeElement.nodeName.toLowerCase() !== "input" && document.activeElement.nodeName.toLowerCase() !== "textarea")) {
                                if (t === 37 || t === 39 || t === 38 || t === 40) {
                                    ...
                                    for (f.rtl && (i.left = i.left - f.container[0].scrollLeft), s = [
                                            [i.left, i.top],
                                            [i.left + f.width, i.top],
                                            [i.left, i.top + f.height],
                                            [i.left + f.width, i.top + f.height]
                                        ], e = 0; e < s.length; e++) r = s[e], r[0] >= u.left && r[0] <= u.left + h && r[1] >= u.top && r[1] <= u.top + c && (o = !0);
                                    if (!o) return
                                }
                        ...
                        function bt(n) {
                            ...
                            if (u === "mousewheel")
                                if (f.params.mousewheelForceToAxis)
                                    if (f.isHorizontal())
                                        if (Math.abs(n.wheelDeltaX) > Math.abs(n.wheelDeltaY)) t = n.wheelDeltaX * r;
                                        else return;
                            else if (Math.abs(n.wheelDeltaY) > Math.abs(n.wheelDeltaX)) t = n.wheelDeltaY;
                            else return;
                            else t = Math.abs(n.wheelDeltaX) > Math.abs(n.wheelDeltaY) ? -n.wheelDeltaX * r : -n.wheelDeltaY;
                            else if (u === "DOMMouseScroll") t = -n.detail;
                            else if (u === "wheel")
                                if (f.params.mousewheelForceToAxis)
                                    if (f.isHorizontal())
                                        if (Math.abs(n.deltaX) > Math.abs(n.deltaY)) t = -n.deltaX * r;
                                        else return;
                            else if (Math.abs(n.deltaY) > Math.abs(n.deltaX)) t = -n.deltaY;
                            else return;
                            else t = Math.abs(n.deltaX) > Math.abs(n.deltaY) ? -n.deltaX * r : -n.deltaY;
                            if (t !== 0) {
                        ...
                        p = {};
                        for (o in u)
                            if (typeof u[o] != "object" || u[o] === null || u[o].nodeType || u[o] === window || u[o] === document || typeof i != "undefined" && u[o] instanceof i || typeof jQuery != "undefined" && u[o] instanceof jQuery) p[o] = u[o];
                            else {
                                p[o] = {};
                                for (ft in u[o]) p[o][ft] = u[o][ft]
                            }
                        for (h in y)
                            if (typeof u[h] == "undefined") u[h] = y[h];
                            else if (typeof u[h] == "object")
                            for (k in y[h]) typeof u[h][k] == "undefined" && (u[h][k] = y[h][k]);
                        if ((f = this, f.params = u, f.originalParams = p, f.classNames = [], typeof n != "undefined" && typeof i != "undefined" && (n = i), typeof n != "undefined" || (n = typeof i == "undefined" ? window.Dom7 || window.Zepto || window.jQuery : i, n)) && (f.$ = n, f.currentBreakpoint = undefined, f.getActiveBreakpoint = function() {
                            ...
                            f.updateAutoHeight = function() {
                                var t = f.slides.eq(f.activeIndex)[0],
                                    n;
                            ...
                            f.updateSlidesSize = function() {
                                ...
                                if (typeof f.size != "undefined") {
                                    ...
                                    var t, s = f.params.slidesPerColumn,
                                        a = o / s,
                                    ...
                                    if (f.virtualSize = Math.max(f.virtualSize, f.size) + f.params.slidesOffsetAfter, f.rtl && f.wrongRTL && (f.params.effect === "slide" || f.params.effect === "coverflow") && f.wrapper.css({
                                        ...
                                        })), f.params.slidesPerColumn > 1 && (f.virtualSize = (t + f.params.spaceBetween) * o, f.virtualSize = Math.ceil(f.virtualSize / f.params.slidesPerColumn) - f.params.spaceBetween, f.wrapper.css({
                                            width: f.virtualSize + f.params.spaceBetween + "px"
                            ...
                            f.updateSlidesProgress = function(n) {
                                var r, t, i, e;
                                if (typeof n == "undefined" && (n = f.translate || 0), f.slides.length !== 0)
                                    for (typeof f.slides[0].swiperSlideOffset == "undefined" && f.updateSlidesOffset(), r = -n, f.rtl && (r = n), f.slides.removeClass(f.params.slideVisibleClass), t = 0; t < f.slides.length; t++) {
                            ...
                            f.updateClickedSlide = function(t) {
                                var r = st(t, "." + f.params.slideClass),
                                    o = !1,
                                    u, i, e;
                                if (r)
                                    for (u = 0; u < f.slides.length; u++) f.slides[u] === r && (o = !0);
                                if (r && o) f.clickedSlide = r, f.clickedIndex = n(r).index();
                                else {
                                ...
                                if (f.params.slideToClickedSlide && f.clickedIndex !== undefined && f.clickedIndex !== f.activeIndex)
                                    if (i = f.clickedIndex, f.params.loop) {
                            ...
                            var c, l, g, nt, w, e, s, tt, ht = "input, select, textarea, button",
                                ct = Date.now(),
                                b, a = [],
                                it;
                            if (f.animating = !1, f.touches = {
                                        ...
                                        if (c = l = !1, o = f.params.followFinger ? f.rtl ? f.translate : -f.translate : -e, f.params.freeMode) {
                                            ...
                                            if (f.params.freeModeMomentum) {
                                                ...
                                                var k = 1e3 * f.params.freeModeMomentumRatio,
                                                    ht = f.velocity * k,
                                                    i = f.translate + ht;
                                                if (f.rtl && (i = -i), d = !1, y = Math.abs(f.velocity) * 20 * f.params.freeModeMomentumBounceRatio, i < f.maxTranslate()) f.params.freeModeMomentumBounce ? (i + f.maxTranslate() < -y && (i = f.maxTranslate() - y), tt = f.maxTranslate(), d = !0, it = !0) : i = f.maxTranslate();
                                                else if (i > f.minTranslate()) f.params.freeModeMomentumBounce ? (i - f.minTranslate() > y && (i = f.minTranslate() + y), tt = f.minTranslate(), d = !0, it = !0) : i = f.minTranslate();
                                                else if (f.params.freeModeSticky) {
                                                    for (h = 0, h = 0; h < f.snapGrid.length; h += 1)
                                                        if (f.snapGrid[h] > -i) {
                                                            p = h;
                                                            break
                                                        }
                                                ...
                                                if (f.velocity !== 0) k = f.rtl ? Math.abs((-i - f.translate) / f.velocity) : Math.abs((i - f.translate) / f.velocity);
                                                else if (f.params.freeModeSticky) {
                                                    f.slideReset();
                                                    return
                                                }
                                    ...
                                    if (f.params.observeParents)
                                        for (t = f.container.parents(), n = 0; n < t.length; n++) lt(t[n]);
                                    lt(f.container[0], {
                                        childList: !1
                                    });
                                    lt(f.wrapper[0], {
                                    ...
                                    if (f.params.loop && f.destroyLoop(), typeof n == "object" && n.length)
                                        for (var t = 0; t < n.length; t++) n[t] && f.wrapper.append(n[t]);
                                    else f.wrapper.append(n);
                                        ...
                                        setTransition: function(n) {
                                            if (f.slides.transition(n), f.params.virtualTranslate && n !== 0) {
                                                ...
                                                f.slides.transitionEnd(function() {
                                                    var i, n;
                                                    if (!t && f)
                                                        for (t = !0, f.animating = !1, i = ["webkitTransitionEnd", "transitionend", "oTransitionEnd", "MSTransitionEnd", "msTransitionEnd"], n = 0; n < i.length; n++) f.wrapper.trigger(i[n])
                                                })
                                            }
                                        }
                                    },
                                            ...
                                            if (f.slides.transition(t).find(".swiper-slide-shadow-top, .swiper-slide-shadow-right, .swiper-slide-shadow-bottom, .swiper-slide-shadow-left").transition(t), f.params.virtualTranslate && t !== 0) {
                                                ...
                                                f.slides.eq(f.activeIndex).transitionEnd(function() {
                                                    ...
                                                    if (!i && f && n(this).hasClass(f.params.slideActiveClass))
                                                        for (i = !0, f.animating = !1, r = ["webkitTransitionEnd", "transitionend", "oTransitionEnd", "MSTransitionEnd", "msTransitionEnd"], t = 0; t < r.length; t++) f.wrapper.trigger(r[t])
                                                })
                                            }
                                        }
                                    },
                                    cube: {
                                        setTranslate: function() {
                                            var e = 0,
                                                t, i, y, h, c, b;
                                            for (f.params.cube.shadow && (f.isHorizontal() ? (t = f.wrapper.find(".swiper-cube-shadow"), t.length === 0 && (t = n('<div class="swiper-cube-shadow"><\/div>'), f.wrapper.append(t)), t.css({
                                                    height: f.width + "px"
                                                })) : (t = f.container.find(".swiper-cube-shadow"), t.length === 0 && (t = n('<div class="swiper-cube-shadow"><\/div>'), f.container.append(t)))), i = 0; i < f.slides.length; i++) {
                                                var u = f.slides.eq(i),
                                                    o = i * 90,
                                                    l = Math.floor(o / 360);
                                            ...
                                            if (f.wrapper.css({
                                                ...
                                                if (f.isHorizontal()) t.transform("translate3d(0px, " + (f.width / 2 + f.params.cube.shadowOffset) + "px, " + -f.width / 2 + "px) rotateX(90deg) rotateZ(0deg) scale(" + f.params.cube.shadowScale + ")");
                                                else {
                                    ...
                                    load: function() {
                                        ...
                                        if (f.params.watchSlidesVisibility) f.wrapper.children("." + f.params.slideVisibleClass).each(function() {
                                            ...
                                            for (t = f.activeIndex; t < f.activeIndex + f.params.slidesPerView; t++) f.slides[t] && f.lazy.loadImageInSlide(t);
                                    ...
                                    setTranslate: function(n, i) {
                                        ...
                                        var r = f.params.control,
                                            o, u, e;
                                        if (f.isArray(r))
                                            for (e = 0; e < r.length; e++) r[e] !== i && r[e] instanceof t && s(r[e]);
                                    ...
                                    setTransition: function(n, i) {
                                        ...
                                        var r = f.params.control,
                                            u;
                                        if (f.isArray(r))
                                            for (u = 0; u < r.length; u++) r[u] !== i && r[u] instanceof t && e(r[u]);
                                        else r instanceof t && i !== r && e(r)
                                    }
                                }, f.hashnav = {
                                    init: function() {
                                        var i, r, n, u, t, e, o;
                                        if (f.params.hashnav && (f.hashnav.initialized = !0, i = document.location.hash.replace("#", ""), i))
                                            for (r = 0, n = 0, u = f.slides.length; n < u; n++) t = f.slides.eq(n), e = t.attr("data-hash"), e !== i || t.hasClass(f.params.slideDuplicateClass) || (o = t.index(), f.slideTo(o, r, f.params.runCallbacksOnInit, !0))
                                    },
                                    setHash: function() {
                            ...
                            return f.callPlugins = function(n) {
                                ...
                                if (f.emitterEventListeners[n])
                                    for (t = 0; t < f.emitterEventListeners[n].length; t++) f.emitterEventListeners[n][t](arguments[1], arguments[2], arguments[3], arguments[4], arguments[5]);
                ...
                for (t.prototype = {
                        ...
                        var n = function(n) {
                            ...
                            t = function(t, i) {
                                ...
                                if (t)
                                    if (typeof t == "string")
                                        if (u = t.trim(), u.indexOf("<") >= 0 && u.indexOf(">") >= 0)
                                            for (f = "div", u.indexOf("<li") === 0 && (f = "ul"), u.indexOf("<tr") === 0 && (f = "tbody"), (u.indexOf("<td") === 0 || u.indexOf("<th") === 0) && (f = "tr"), u.indexOf("<tbody") === 0 && (f = "table"), u.indexOf("<option") === 0 && (f = "select"), s = document.createElement(f), s.innerHTML = t, r = 0; r < s.childNodes.length; r++) e.push(s.childNodes[r]);
                                        else
                                            for (o = i || t[0] !== "#" || t.match(/[ .<>:~]/) ? (i || document).querySelectorAll(t) : [document.getElementById(t.split("#")[1])], r = 0; r < o.length; r++) o[r] && e.push(o[r]);
                                else if (t.nodeType || t === window || t === document) e.push(t);
                                else if (t.length > 0 && t[0].nodeType)
                                    for (r = 0; r < t.length; r++) e.push(t[r]);
                                return new n(e)
                            };
                        return n.prototype = {
                            addClass: function(n) {
                                ...
                                for (r = n.split(" "), t = 0; t < r.length; t++)
                                    for (i = 0; i < this.length; i++) this[i].classList.add(r[t]);
                                return this
                            },
                            removeClass: function(n) {
                                for (var t, r = n.split(" "), i = 0; i < r.length; i++)
                                    for (t = 0; t < this.length; t++) this[t].classList.remove(r[i]);
                                return this
                            },
                            hasClass: function(n) {
                            ...
                            toggleClass: function(n) {
                                for (var t, r = n.split(" "), i = 0; i < r.length; i++)
                                    for (t = 0; t < this.length; t++) this[t].classList.toggle(r[i]);
                                return this
                            },
                            attr: function(n, t) {
                                var i, r;
                            ...
                            on: function(n, i, r, u) {
                                function s(n) {
                                    var e = n.target,
                                        f, u;
                                    if (t(e).is(i)) r.call(e, n);
                                    else
                                        for (f = t(e).parents(), u = 0; u < f.length; u++) t(f[u]).is(i) && r.call(f[u], n)
                                }
                                for (var o = n.split(" "), e, f = 0; f < this.length; f++)
                                    if (typeof i == "function" || i === !1)
                                        for (typeof i == "function" && (r = arguments[1], u = arguments[2] || !1), e = 0; e < o.length; e++) this[f].addEventListener(o[e], r, u);
                                    else
                                        for (e = 0; e < o.length; e++) this[f].dom7LiveListeners || (this[f].dom7LiveListeners = []), this[f].dom7LiveListeners.push({
                                            listener: r,
                                            liveListener: s
                            ...
                            off: function(n, t, i, r) {
                                for (var u, f, o = n.split(" "), e = 0; e < o.length; e++)
                                    for (u = 0; u < this.length; u++)
                                        if (typeof t == "function" || t === !1) typeof t == "function" && (i = arguments[1], r = arguments[2] || !1), this[u].removeEventListener(o[e], i, r);
                                        else if (this[u].dom7LiveListeners)
                                    for (f = 0; f < this[u].dom7LiveListeners.length; f++) this[u].dom7LiveListeners[f].listener === i && this[u].removeEventListener(o[e], this[u].dom7LiveListeners[f].liveListener, r);
                                return this
                            },
                            ...
                            is: function(i) {
                                ...
                                if (typeof i == "string") {
                                    ...
                                    for (f = t(i), u = 0; u < f.length; u++)
                                        if (f[u] === this[0]) return !0;
                                    return !1
                                }
                                if (i === document) return this[0] === document;
                                if (i === window) return this[0] === window;
                                if (i.nodeType || i instanceof n) {
                                    for (f = i.nodeType ? [i] : i, u = 0; u < f.length; u++)
                                        if (f[u] === this[0]) return !0;
                                    return !1
                                }
                                return !1
                            ...
                            index: function() {
                                if (this[0]) {
                                    for (var n = this[0], t = 0;
                                        (n = n.previousSibling) !== null;) n.nodeType === 1 && t++;
                                    return t
                                }
                                return undefined
                            },
                            ...
                            append: function(t) {
                                for (var r, u, i = 0; i < this.length; i++)
                                    if (typeof t == "string")
                                        for (u = document.createElement("div"), u.innerHTML = t; u.firstChild;) this[i].appendChild(u.firstChild);
                            ...
                            prepend: function(t) {
                                for (var r, u, i = 0; i < this.length; i++)
                                    if (typeof t == "string")
                                        for (u = document.createElement("div"), u.innerHTML = t, r = u.childNodes.length - 1; r >= 0; r--) this[i].insertBefore(u.childNodes[r], this[i].childNodes[0]);
                                    else if (t instanceof n)
                            ...
                            insertBefore: function(n) {
                                for (var r, i = t(n), u = 0; u < this.length; u++)
                                    if (i.length === 1) i[0].parentNode.insertBefore(this[u], i[0]);
                                    else if (i.length > 1)
                                    for (r = 0; r < i.length; r++) i[r].parentNode.insertBefore(this[u].cloneNode(!0), i[r])
                            },
                            insertAfter: function(n) {
                                for (var r, i = t(n), u = 0; u < this.length; u++)
                                    if (i.length === 1) i[0].parentNode.insertBefore(this[u], i[0].nextSibling);
                                    else if (i.length > 1)
                                    for (r = 0; r < i.length; r++) i[r].parentNode.insertBefore(this[u].cloneNode(!0), i[r].nextSibling)
                            },
                            next: function(i) {
                            ...
                            find: function(t) {
                                for (var u, i, f = [], r = 0; r < this.length; r++)
                                    for (u = this[r].querySelectorAll(t), i = 0; i < u.length; i++) f.push(u[i]);
                                return new n(f)
                            },
                            children: function(i) {
                                for (var u, r, f = [], e = 0; e < this.length; e++)
                                    for (u = this[e].childNodes, r = 0; r < u.length; r++) i ? u[r].nodeType === 1 && t(u[r]).is(i) && f.push(u[r]) : u[r].nodeType === 1 && f.push(u[r]);
                            ...
                            add: function() {
                                for (var n = this, r, u, i = 0; i < arguments.length; i++)
                                    for (u = t(arguments[i]), r = 0; r < u.length; r++) n[n.length] = u[r], n.length++;
                                return n
                            }
        ...
        genReviews: function(t) {
            var l = BPR.language,
                ...
                c, f, r, u, i, s, e;
            if (o != null) {
                for (c = o.length, f = 0; f < c; f++) r = o[f], u = "", r.reply != null && (u += '<div class="bizweb-review-reply">', u += '<p class="bizweb-review-reply-body">' + r.reply.content + "<\/p>", u += '<span class="bizweb-review-reply-shop">- ' + r.reply.author_name + "<\/span>", u += "<\/div>"), i = "", i += '<div id="bizweb-review-' + r.id + '" class="bizweb-review" itemscope="" itemtype="http://data-vocabulary.org/Review">', i += '<div class="bizweb-review-header">', i += "<div>", i += '<div class="bizweb-review-header-img">', i += '<img src="' + BPR.host + '/assets/images/user.png" width="16" height="15"/>', i += "<\/div>", i += "<\/div>", i += "<div>", i += '<span class="bizweb-review-header-byline">' + r.author_name + "<\/span>", i += '<div class="bizweb-product-reviews-star" data-score="' + r.rating + '" data-number="5"><\/div>', i += '<span class="bizweb-review-header-time">' + r.time + "<\/span>", i += "<\/div>", i += '<div class="bizweb-review-reportreview">', BPR.checkReviewReport(r.id) ? i += '<a href="javascript: void(0);" style="color: red;"><i aria-hidden="true" class="fa fa-warning"><\/i><\/a>' : (i += '<a onclick="BPR.reportReview(' + r.id + ');return false" title="' + l.report + '" href="javascript: void(0);">', i += '<i aria-hidden="true" class="fa fa-warning"><\/i>', i += "<\/a>"), i += "<\/div>", i += '<p class="bizweb-review-header-title">' + r.title + "<\/p>", i += "<\/div>", i += '<div class="bizweb-review-content">', i += '<p class="bizweb-review-content-body">' + r.content + "<\/p>", i += "<\/div>", i += u, i += '<div class="bizweb-review-footer">', i += "", i += "<\/div>", i += '<div style="display:none;"><span itemprop="itemreviewed">' + BPR.product.product_name + '<\/span><span itemprop="rating">' + r.rating + "<\/span><\/div>", i += "<\/div>", h += i;
        ...
        checkCommentator: function() {
            var i = n(BPR.reviewEl).attr("data-id"),
                t;
        ...
        loadProduct: function() {
            if (this.reviewEl != null && this.reviewEl.length != 0) {
                var t = n(this.reviewEl).attr("data-id"),
                    i = {
                        productId: t,
                        store: this.store
                    };
        ...
        productCallback: function(t) {
            ...
            return BPR.product = {
                ...
                language: i
            }), t.name_help == "" && (t.name_help = i.form.review_author), t.email_help == "" && (t.email_help = i.form.review_email), n("#bizweb-product-reviews").loadTemplate(BPR.host + "assets/template/bpr.html", t, {
                complete: function() {
                    BPR.genReviews(t);
        ...
        loadBadges: function() {
            var t = this.badgeEls.map(function() {
                ...
                i;
            if (t.length > 0) return i = n.extend({
                productIds: t.splice(0)
            }, BPR.extraAjaxParams), n.ajax({
        ...
        badgesCallback: function(t) {
            BPR.badgeEls.each(function() {
                var u = n(this).attr("data-id"),
                    r = BPR.filterBadge(t.badges, u),
                    i = "";
                r != null ? (i += '<div class="bizweb-product-reviews-star" data-score="' + r.rating + '" data-number="5" ><\/div>', i += "<div><p>" + r.votes + "<\/p><\/div>", i += '<div><img src="' + BPR.host + '/assets/images/user.png" width="18" height="17"/><\/div>') : (i += '<div class="bizweb-product-reviews-star" data-score="0" data-number="5" ><\/div>', i += "<div><p>" + r.votes + "<\/p><\/div>", i += '<div><img src="' + BPR.host + '/assets/images/user.png" width="22" height="20"/><\/div>');
                n(this).html(i)
            });
            BPR.loadBadgeStar()
        },
        ...
        reportReview: function(t) {
            ...
            return confirm(r.report_alert) && (i = n.extend({
                id: t
            }, BPR.extraAjaxParams), n.get("" + BPR.host + "/reviews/report", i, BPR.reportCallback, "jsonp")), !1
        },
        ...
        productsModuleCallback: function(t) {
            if (t != null && !(t.length <= 0)) {
                ...
                n(".bpr-products-module-body.swiper-container").length && n(".bpr-products-module-body.swiper-container").length > 0 && n(".bpr-products-module-body.swiper-container").each(function(t) {
                    var e = n(this),
                        o = e.parents(".bpr-products-module-container"),
                        s = e.find(".bpr-wrapper-outer"),
                        u, f;
                    ...
                    f = s.width();
                    f <= 320 ? (u.slidesPerView = 1, u.spaceBetween = 0, u.breakpoints = {}) : f <= 768 ? (u.slidesPerView = 2, u.spaceBetween = 10, u.breakpoints = {
                        320: {
                            slidesPerView: 1,
                            spaceBetween: 0
                        }
                    }) : f <= 992 ? (u.slidesPerView = 3, u.spaceBetween = 20, u.breakpoints = {
                        320: {
                            slidesPerView: 1,
                            spaceBetween: 0
                        },
                    ...
                    }) : (u.slidesPerView = i, u.spaceBetween = 30, u.breakpoints = {
                        320: {
                            slidesPerView: 1,
                            spaceBetween: 0
                        },
                    ...
                    r[t] = new Swiper(".bpr-products-module-body.swiper-container.instance-" + t + " .bpr-wrapper-outer", u)
                });
                n(".bizweb-product-reviews-module .bpr-product-star").raty({
                    starType: "i",
                    number: function() {
                        return n(this).attr("data-number")
                    },
